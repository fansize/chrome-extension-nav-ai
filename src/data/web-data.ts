...
export const popularChannels: ChannelItem[] = [
    ...
    { name: "SEO搜索关键词推荐", icon: "assets/images/icons/linus-tech-tips.png", description: "自动优化关键词，提高在搜索引擎中的排名和曝光率", url: "https://www.chat123.ai/seo-keywords" },
    { name: "买家消息回复", icon: "assets/images/icons/doctor-mike.png", description: "根据买家消息快速生成符合标准的回复模板", url: "https://www.chat123.ai/amazon-reply" },
    { name: "亚马逊5点描述优化", icon: "assets/images/icons/mrbeast.png", description: "撰写高效精炼的5点描述,高埋词率,突出商品特色", url: "https://www.chat123.ai/amazon-msyh" },
]
